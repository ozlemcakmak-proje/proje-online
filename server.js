...
// Statik dosyaları (HTML, CSS, JS) ana dizinden sun
app.use(express.static(__dirname));

// --- Ana Sayfa Yönlendirmesi ---
// Site açıldığında direkt index.html dosyasını gönderir
app.get('/', (req, res) => {
    res.sendFile(path.join(__dirname, 'index.html'));
});

// OpenAI Yapılandırması
// Render'da Environment Variables kısmına OPENAI_API_KEY eklemeyi unutma
